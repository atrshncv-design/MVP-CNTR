...
| R17 | P1 → INF-08 лимиты контейнеров | done | BACKLOG INF-08 | — |
| R18 | P1 → INF-09 ротация логов | done | BACKLOG INF-09 | — |
| R19 | P1 → INF-12 nginx hardening (resolver, rate limit, gzip, cache) | done | BACKLOG INF-12 | — |
| R20 | P1 → INF-13 SPOF один хост + DR-runbook | done | BACKLOG INF-13 | — |
| R21 | P1 → N-18 rate limit публичных реестров | done | BACKLOG N-18 | — |
| R22 | интервью: Туно tuno vs Каба kaba 0028 contour, админка max 19-, пагинация 20 27-, хотфиксы 28- | done | интервью 14/V2 | — |
| R23 | интервью: мэтчинг LLM кросс-отрасль 5 полей 25- топ-5 через центр 14- | done | интервью Q34 | — |
| R24 | интервью: доки мгновенные 22- + SOPS 23- | done | интервью Q24 | — |
