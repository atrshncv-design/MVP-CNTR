...
|---|---|---|---|
| 2026-08-25 | `2026-08-25-deploy-readiness-audit` | сдан | аудит+ремонт платформы к B2G-деплою: консолидированная ветка, 271 тест, ИБ-базовая линия, прод-контур проверен, производительность измерена; отчёт и ADR внутри |
| 2026-08-26 | `2026-08-26-m0-security-hardening--wip` | в работе | — |
