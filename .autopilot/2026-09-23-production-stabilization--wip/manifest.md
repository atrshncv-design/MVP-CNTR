...
| R20 | «C4 — топология и зелёные гейты» (воспроизводимое окружение, зелёные backend/frontend/CI, решение SPOF / план HA) | in-ticket | Backend Python 3.11 mypy/Ruff/720 pytest GREEN; frontend T25 webpack build/238 tests PASS, Turbopack локально EPERM; CI npm audit D05-D07; topology T20 впереди | `evidence/T27-verification.md`, `evidence/T25-verification.md`, `evidence/CI-dependency-audit.md` |
