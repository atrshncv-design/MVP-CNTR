...
| R20 | «C4 — топология и зелёные гейты» (воспроизводимое окружение, зелёные backend/frontend/CI, решение SPOF / план HA) | in-ticket | Backend Python 3.11 gates GREEN; T28 Next critical снят, frontend webpack build/238 tests PASS; CI audit high D06/D07 и lint D08 остаются, Turbopack локально EPERM; topology T20 впереди | `evidence/T27-verification.md`, `evidence/T28-verification.md` |
...
| D06 | CI frontend `npm audit` выявил `sharp` high (libheif) | in-ticket | T29: перепроверить после T28 и при необходимости минимально обновить | `evidence/CI-dependency-audit.md` |
