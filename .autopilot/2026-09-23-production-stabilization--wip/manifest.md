...
| R20 | «C4 — топология и зелёные гейты» (воспроизводимое окружение, зелёные backend/frontend/CI, решение SPOF / план HA) | in-ticket | Backend pytest/Ruff зелёные; T25 exact-font webpack build и 238 тестов PASS, штатный Turbopack локально EPERM; Python 3.11 mypy показывает D03/D04; topology T20 впереди | `evidence/T25-verification.md`, `evidence/T04-verification.md` |
