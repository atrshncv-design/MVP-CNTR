...
| D03 | Обнаружено в T04: mypy `[no-untyped-call]` в `app/api/v1/realtime.py:109` после обхода numpy-stub mismatch | in-ticket | T26: типобезопасный вызов Redis client | `evidence/T04-verification.md` |
