window.STATE =
{
  ...
  "tickets": [
    ...
    { "id": "07", "title": "Сборка, зависимости, тесты и CI", "requirements": ["R17", "R31", "R32", "R42i"], "blockedBy": [], "wave": 1, "zone": ["evidence/07"], "status": "done", "startedAt": "2026-09-10T09:31:00+04:00", "finishedAt": "2026-09-11T09:35:00+04:00", "retries": 0, "repairs": 0, "handoffs": 0, "tests": { "passed": 212, "failed": 0 }, "commit": "PENDING07" },
  ...
  "concerns": [
    ...
    ,"T07 Next severity по reachable; mypy severity по gate; dependencies дописать; ASGI/nginx gap в T10"
  ],
