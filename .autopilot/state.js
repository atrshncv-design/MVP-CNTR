window.STATE =
{
  ...
  "updatedAt": "2026-09-10T09:55:00+04:00",
  "finishedAt": null,
  "stages": [
  ...
  "tickets": [
    ...
    { "id": "04", "title": "База данных, миграции и запросы", "requirements": ["R22", "R23", "R26", "R27"], "blockedBy": [], "wave": 1, "zone": ["evidence/04"], "status": "done", "startedAt": "2026-09-10T09:13:13+04:00", "finishedAt": "2026-09-11T09:10:00+04:00", "retries": 0, "repairs": 1, "repairFindings": ["доказать полный model/migration/downgrade inventory; model-to-migration/predicate-index; heavy JOIN/long transaction/deadlock; disposable DB blocker; Ruff red указать как fail"], "handoffs": 0, "tests": { "passed": 0, "failed": 0 }, "commit": "PENDING04" },
    { "id": "05", "title": "AI, RAG и файлы", "requirements": ["R24", "R25", "R28-R30", "R34", "R35"], "blockedBy": [], "wave": 1, "zone": ["evidence/05"], "status": "review", "startedAt": "2026-09-10T09:13:13+04:00", "retries": 1, "repairs": 0, "handoffs": 0 },
    { "id": "06", "title": "DevOps, production security и восстановление", "requirements": ["R24-R27", "R33", "R42i"], "blockedBy": [], "wave": 1, "zone": ["evidence/06"], "status": "review", "startedAt": "2026-09-10T09:13:13+04:00", "retries": 0, "repairs": 0, "handoffs": 0 },
