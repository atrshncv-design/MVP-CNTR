...
- NextAuth.js is the authentication boundary. Do not ship mock/static behavior
  as a completed backend integration.
- Rerun lint/build/browser gates before handoff. Push every commit to `origin`.
