...
export function Ugt8Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
<path d="M12 10.7V9" />
<path d="M14.22 11.14L14.87 9.57" />
<path d="M16.1 12.4L17.3 11.2" />
<path d="M17.36 14.28L18.93 13.63" />
<path d="M17.8 16.5H19.5" stroke="var(--tz-border)" strokeOpacity={0.55} />
<path d="M12 16.5L16.25 14.74" strokeWidth={2} />
<circle cx="12" cy="16.5" r="1.15" fill="var(--tz-ugt-8)" stroke="none" />
    </svg>
  );
}
