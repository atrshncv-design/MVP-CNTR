...
export function Ugt1Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
<path d="M6.64 14.28L5.07 13.63" stroke="var(--tz-border)" strokeOpacity={0.55} />
<path d="M7.9 12.4L6.7 11.2" stroke="var(--tz-border)" strokeOpacity={0.55} />
<path d="M9.78 11.14L9.13 9.57" stroke="var(--tz-border)" strokeOpacity={0.55} />
...
<path d="M12 16.5H7.4" strokeWidth={2} />
<circle cx="12" cy="16.5" r="1.15" fill="var(--tz-ugt-1)" stroke="none" />
    </svg>
  );
}
