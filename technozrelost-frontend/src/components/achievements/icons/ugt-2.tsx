...
export function Ugt2Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
<path d="M12 16.5L7.75 14.74" strokeWidth={2} />
<circle cx="12" cy="16.5" r="1.15" fill="var(--tz-ugt-2)" stroke="none" />
    </svg>
  );
}
