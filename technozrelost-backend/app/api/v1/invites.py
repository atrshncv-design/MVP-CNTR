...
async def create_invite(
    project_id: int, payload: InviteIn, db: DBSession, user: VerifiedUser
) -> InviteOut:
...
async def accept_invite(
    payload: InviteAcceptIn, db: DBSession, user: VerifiedUser
) -> dict:
...
async def revoke_invite(
    project_id: int, invite_id: int, db: DBSession, user: VerifiedUser
) -> InviteOut:
    await require_project_admin(db, project_id, user)
...
async def transfer_project_admin(
    project_id: int, payload: TransferAdminIn, db: DBSession, user: VerifiedUser
) -> dict:
    await require_project_admin(db, project_id, user)
