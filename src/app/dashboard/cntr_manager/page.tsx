    ...
    <section>
      ...
      <div className="border-b border-[#DFE5EC] pb-6">
        <p className="font-mono text-xs uppercase tracking-[0.08em] text-slate-500">
          Рабочий стол менеджера ЦНТР
        </p>
        <h1 className="mt-2 text-3xl font-bold tracking-[-0.03em] text-[#0F172A]">
          Добро пожаловать, {displayName}
        </h1>
        <p className="mt-2 max-w-2xl text-slate-600">
          Оркестрация проектов платформы: от заявки заказчика до внедрения технологии.
          Здесь отображаются все проекты экосистемы «Технозрелость».
        </p>
      </div>
      ...
      <nav aria-label="Разделы рабочего стола" className="flex gap-6 border-b border-[#DFE5EC]">
        ...
        <Link href="/dashboard/ai-assistant" className="py-4 text-slate-600 hover:text-[#0F172A]">
          ИИ-ассистент
        </Link>
      </nav>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_360px]">
        {/* Все проекты */}
        <div>
          <h2 className="mb-4 text-lg font-bold text-[#0F172A]">Все проекты</h2>
        ...
        {/* Вступление по токену + ассистент */}
          ...
          {loading ? (
            ...
            <>
              ...
              <Link
                ...
                className="group flex items-center justify-between rounded-2xl border border-[#E8ECF0] bg-white p-5 transition hover:border-[#2E5BFF]"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-[#0F172A]">ИИ-ассистент</p>
                    <p className="text-sm text-slate-500">Генерация документов и отчётов</p>
                  </div>
                </div>
                <ArrowRight
                  size={18}
                  className="text-slate-300 transition group-hover:translate-x-1 group-hover:text-[#2E5BFF]"
                />
              </Link>
            </>
          )}
